                        ...
                        <div class="container mt-3">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <form action="../../controllers/utilisateur/ajout.php?id=<?= $id_pat ?>" method="post" class="d-flex mb-4 mx-1">
                                        <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="resultat" required>
                                            <option value="">Donner une décision</option>
                                            <option value="guérie">Guérie</option>
                                            <option value="décédée">Décès</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    ?>
                                    <form action="../../controllers/utilisateur/ajout.php?id=<?= $id_pat ?>" method="post" class="d-flex mb-4 mx-1">
                                        <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="transfert" required>
                                            <option value="">Effectuer un transfer</option>
                                            <?php while ($values = $data2->fetch(PDO::FETCH_OBJ)) { ?>
                                                <option value="<?= $values->hopital ?>"><?= $values->hopital ?></option>
                                            <?php } ?>
                                        </select>
                                        <button class="btn btn-outline-success mx-2" type="submit" name=""><i class="fa fa-paper-plane" aria-hidden="true"></i></i></button>
                                    </form>
                                </div>
                            </div>
                        </div>
