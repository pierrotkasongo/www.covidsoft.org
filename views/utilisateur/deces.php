                        ...
                        <div class="row">
                            <div class="col-md-2 mt-2">
                                ...
                                <div class="container groupe">
                                    ...
                                    <div class="div"><a href="deces.php" class="active">Décès</a></div>
                                ...
                                <div class="table-responsive">
                                    <table class="table  table-sm">
                                        <tbody>
                                            ...
                                            <?php
                                            $execution = Affichage_patient($hopital, 'décédée', $connexion);
                                            ...
                                            <?php if ($execution->rowCount() > 0) { ?>
                                                <?php while ($values = $execution->fetch(PDO::FETCH_OBJ)) { ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="patient_decede.php?id_pat=<?= $values->id ?>"><i class="fas fa-chalkboard-teacher"></i></a></td>
                                                    </tr>
                                                <?php } ?>
                                            <?php  } else { ?>
